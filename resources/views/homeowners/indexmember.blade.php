        ...
        <div class="container">
            <div class="container">
                <h2 class="mt-4 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{route('homeowners.createmember')}}" class="btn btn-success">Add Member</a>
                </h2>
              <!-- Table -->
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td>{{ $homeowner->id }}</td>
            <td>{{ $homeowner->homeOwnerName }}</td>
            <td>{{ $homeowner->blockAndHouseNo }}</td>
            <td>{{ $homeowner->address }}</td>
            <td>{{ $homeowner->phone }}</td>
            <td>
                <!-- Add your CRUD operation buttons here -->
                <!-- Example: Edit and Delete -->
                <a href="{{ route('homeowners.edit', $homeowner->id) }}" class="btn btn-primary">Edit</a>
